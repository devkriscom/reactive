...
export const PostFeed = ({
    ...
    const fragment = cn('post-feed', className);
    ...
    return (<Fragment>
        <Tag className={fragment}>
          ...
          <div className="meta">
            ...
            <a className="comments ml-5" href={link}>6</a>
        </div>
        <summary className="summary">
          <p>
            {content}
            <a className="read_more" href={link}><FormattedMessage id="more" /></a>
        </p>
    </summary>
</Tag>
</Fragment>
...
export const PostFeedMini = ({
    ...
    const fragment = cn('post-feed-widget', className);
    return (
      <Fragment>
